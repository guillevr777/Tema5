...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Comparator<Futbolista> PorEdad = (a,b) -> { return a.getEdad() - b.getEdad();};
		
		System.out.println();
		futbolistas.sort(PorEdad);
		...
		Comparator<Futbolista> PorNombre = (a,b) -> { return a.getNombre().compareTo(b.getNombre());};
		
		System.out.println();
		futbolistas.sort(PorNombre);
